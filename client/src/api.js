...
export const getTestEnvironment = (params = {}) => api.get('/system/test-environment', { params }).then(r => r.data)
export const cleanupTestEnvironment = (data = {}) => api.post('/system/test-environment/cleanup', data).then(r => r.data)
export const runSystemAcceptance = (data = {}) => api.post('/system/acceptance', data).then(r => r.data)
